...
namespace Error {
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(304, "[ SEMANTIC ] Объявление переменной без ключевого слова create"),
		...
		ERROR_ENTRY(601, "[ SYNTAX ] Отсутствует список параметров функции"),
		ERROR_ENTRY(602, "[ SYNTAX ] Ошибка в параметрах функции"),
		ERROR_ENTRY(603, "[ SYNTAX ] Отсутствует тело функции"),
		ERROR_ENTRY(604, "[ SYNTAX ] Недопустимое выражение"),
		ERROR_ENTRY(605, "[ SYNTAX ] Отсутствует тело условия или цикла"),
		...
		ERROR_ENTRY(611, "[ SYNTAX ] Ошибка в арифметическом выражении"),
		ERROR_ENTRY(612, "[ SYNTAX ] Неверная конструкция в теле цикла или условия"),
